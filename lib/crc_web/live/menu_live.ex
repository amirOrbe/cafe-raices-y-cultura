defmodule CRCWeb.MenuLive do
  ...
  def render(assigns) do
    ...
    <!-- Category tabs -->
            <div
              :if={@categories != []}
              class="flex gap-2 sm:gap-3 overflow-x-auto pb-3 mb-8 sm:mb-10 scrollbar-hide"
            >
                  ...
                  class={[
                    ...
                    if(@active_category && @active_category.id == category.id,
                      do: "bg-primary text-primary-content shadow-sm",
                        ...
                        "bg-transparent text-base-content/70 border border-base-300 hover:border-primary hover:text-primary"
                    )
                  ]}
                >
                  {category.name}
    ...
    <!-- Bottom nav -->
            <div class="text-center mt-14 sm:mt-16 pt-8 border-t border-base-300">
              <a
                href="/"
                class="text-sm text-base-content/40 hover:text-primary transition-colors inline-flex items-center gap-1"
              >
                <svg
                ...
                <div class="bg-base-100 rounded-2xl border border-primary/20 shadow-sm overflow-hidden flex flex-col hover:shadow-md transition-shadow">
                  ...
                  <div class="bg-primary/10 px-5 py-4 border-b border-primary/15">
                    <div class="flex items-start justify-between gap-3">
                      ...
                      <span class="badge badge-primary badge-sm whitespace-nowrap shrink-0">
                        Combo
                      </span>
                    </div>
