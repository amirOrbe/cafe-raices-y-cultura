defmodule CRCWeb.HomeLive do
  ...
  # ---------------------------------------------------------------------------
  # Colaboraciones — experiencias reales + apertura a nuevas propuestas
  # ---------------------------------------------------------------------------

  defp colaboraciones_section(assigns) do
    ~H"""
    <section id="colaboraciones" class="py-16 sm:py-20 lg:py-24 bg-base-200">
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="text-center mb-12 sm:mb-16">
          ...
          <p class="mt-4 text-base-content/60 text-base sm:text-lg max-w-2xl mx-auto">
            CRC nació como punto de encuentro. Músicos, poetas, baristas y artistas
            han encontrado en nuestro espacio el escenario perfecto para compartir su trabajo
            con la comunidad de Santa María la Ribera.
          </p>
        </div>

        <!-- Colaboraciones pasadas -->
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5 sm:gap-6 mb-16">
        ...
        <!-- CTA: abiertos a colaboraciones -->
        <div class="bg-primary rounded-3xl px-6 py-10 sm:px-10 sm:py-14 text-center text-primary-content">
