defmodule CRC.Repo.Migrations.CreateProductionTables do
  ...
  def change do
    ...
    create table(:production_recipes) do
      ...
      add :yield_quantity, :decimal, null: false   # how much is produced per batch
      add :yield_unit, :string, null: false         # unit of the output (ml, gramos, porciones…)
      add :notes, :text
    ...
    create table(:production_recipe_ingredients) do
      ...
      add :quantity, :decimal, null: false   # amount consumed per single batch
    ...
    create table(:production_logs) do
      ...
      add :batches, :decimal, null: false, default: 1  # multiplier (1 = one batch, 2.5 = two and a half)
      add :notes, :text
